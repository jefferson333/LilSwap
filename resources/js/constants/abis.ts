export const ABIS = {
    ...
    ADAPTER: [
        "function swapDebt((address debtAsset, uint256 debtRepayAmount, uint256 debtRateMode, address newDebtAsset, uint256 maxNewDebtAmount, address extraCollateralAsset, uint256 extraCollateralAmount, uint256 offset, bytes paraswapData) params, (address debtToken, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) creditPermit, (address aToken, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) collateralPermit) external",
